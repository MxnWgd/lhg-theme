    ...
    <details class="event-wrapper-description">
      ...
      <div>
        <?php
          ...
          if (!$more_tag_pos) {
            echo wpautop(strip_tags(get_post_meta(get_the_ID(), 'event_desc', true), '<p><a><b><i><em><strong><del>'));
          } else {
            echo wpautop(strip_tags(substr(get_post_meta(get_the_ID(), 'event_desc', true), 0, $more_tag_pos + 11), '<p><a><b><i><em><strong><del>'));
          }
        ?>
